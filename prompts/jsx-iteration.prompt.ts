/**
 * Prompt template for generating JSX canvas-component iterations from the original source.
 */
import { fillTemplate } from './utility';

const prompt = `
{{skillSection}}
JSX COMPONENT ITERATION REQUEST
════════════════════════════════
...
export interface JsxIterationPromptVars {
  skillSection?: string;
...
export function jsxIterationPrompt(vars: JsxIterationPromptVars): string {
