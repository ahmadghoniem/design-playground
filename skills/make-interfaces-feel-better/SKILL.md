...
| --- | --- |
| [Typography](make-interfaces-feel-better/typography.md) | Text wrapping, font smoothing, tabular numbers |
| [Surfaces](make-interfaces-feel-better/surfaces.md) | Border radius, optical alignment, shadows, image outlines, hit areas |
| [Animations](make-interfaces-feel-better/animations.md) | Interruptible animations, enter/exit transitions, icon animations, scale on press |
| [Performance](make-interfaces-feel-better/performance.md) | Transition specificity, `will-change` usage |
...
- [typography.md](make-interfaces-feel-better/typography.md) — Text wrapping, font smoothing, tabular numbers
- [surfaces.md](make-interfaces-feel-better/surfaces.md) — Border radius, optical alignment, shadows, image outlines
- [animations.md](make-interfaces-feel-better/animations.md) — Interruptible animations, enter/exit transitions, icon animations, scale on press
- [performance.md](make-interfaces-feel-better/performance.md) — Transition specificity, `will-change` usage
