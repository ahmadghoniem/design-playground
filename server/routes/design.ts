...
function buildGenerateFromCodebasePrompt(opts: BuildPromptOpts): string {
  ...
  return [
    ...
    '   - Existing UI components under src/components/** and src/app/**/*.tsx — note their actual padding/radius/typography classes. EXCLUDE src/app/playground/**, app/playground/**, and public/.playground/** entirely; those are tooling, not the host app\'s product surface.',
    ...
    '',
    'STRICT REQUIREMENTS:',
    '- HOST APP ONLY. Do not read or derive values from: node_modules/, .next/, .git/, src/app/playground/**, app/playground/**, public/.playground/**, or any path outside the current working directory.',
