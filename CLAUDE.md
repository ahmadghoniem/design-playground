...
- Root-pinned (do not move): `dev-entry.tsx`, `registry.tsx`, `playground-tailwind-entry.css`, `setup.mjs`, `bunfig.toml`, `knip.json`, `tsconfig.json`. Content/generated dirs stay put: `iterations/`, `skills/` (skill markdown), `assets/`, `styles/`.
